function [Pfi,Dg,SDg,D90,Dimean] = Calc_GSD_PfiDgSdgD90Dimean_noArray(Fi_cum,Sizes,gsd_MG,nodes_N)
...
% --- Dimean added by Tobias, representative grain size for each class
...
%for d=1:m
%psi=log2(Sizes(:));
psi=log2(transpose(repmat(Sizes(:),1,nodes_N)));
%end
